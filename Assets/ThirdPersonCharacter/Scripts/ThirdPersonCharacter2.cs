...
namespace UnityStandardAssets.Characters.ThirdPerson2
{
	...
	public class ThirdPersonCharacter2 : MonoBehaviour
	{
		...
		void Start()
		{
			...
			m_Rigidbody.constraints = RigidbodyConstraints.FreezeRotationX | RigidbodyConstraints.FreezeRotationY | RigidbodyConstraints.FreezePositionY | RigidbodyConstraints.FreezeRotationZ;
		...
		void UpdateAnimator(Vector3 move)
		{
			...
			m_Animator.SetBool("Squat", m_Crouching);
